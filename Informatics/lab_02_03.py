...
list1 = [int(input('Введите число (10 раз): ')) for i in range(10)]
# Sort by descending
list1.sort(reverse=True)

print('Последние 5 значений отсортированного списка:', list1[:-5], '\n')

# Задание 10
print('Задание 10')

list2 = list1.copy()
print('До инверсии:', list2)
list2.reverse()
print('После после:', list2)
print("__________")